...
# Define constants
IMAGES_PATH = '<path_to>/manipulator_project/programs/pt_to_hef_converter/data/images'
LABELS_PATH = '<path_to>/manipulator_project/programs/pt_to_hef_converter/data/labels'
OUTPUT_CALIB_PATH = '<path_to>/manipulator_project/programs/pt_to_hef_converter/calibration_set'
MODEL_NAME = '<path_to>/manipulator_project/programs/pt_to_hef_converter/local_attenttion_yolov8m/own_yolov8m_lca_light_v2.har'
QUANTIZED_MODEL_NAME = f'{MODEL_NAME.split(".")[0]}_quantized_model.har'
NUM_CLASSES = 14
IMAGES_PER_CLASS = 4
...
calib_dataset = np.array([preproc(img) for img in sorted(calib_images)], dtype=np.uint8)
...
alls = '''
quantization_param([conv58, conv69, conv79], force_range_out=[0.0, 1.0])
normalization1 = normalization([0.0, 0.0, 0.0], [255.0, 255.0, 255.0])
nms_postprocess("<path_to>/config/postprocess_config/own_yolov8m_lca_light_v2_nms_config.json", meta_arch=yolov8, engine=cpu)
'''
